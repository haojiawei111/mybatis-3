...
public class MapperMethod {
  ...
  public static class SqlCommand {
    ...
    /**
     * name 属性，对应 MappedStatement#getId() 方法获得的标识。
  ...
  public static class MethodSignature {
    ...
    public MethodSignature(Configuration configuration, Class<?> mapperInterface, Method method) {
      ...
      // <1> 初始化 mapKey  调用 #getMapKey(Method method) 方法，获得注解的 {@link MapKey#value()}
      this.mapKey = getMapKey(method);
      // 初始化 returnsMap
      this.returnsMap = this.mapKey != null;
      // <2> 初始化 rowBoundsIndex、resultHandlerIndex
      // 调用 #getUniqueParamIndex(Method method, Class<?> paramType) 方法，获得指定参数类型在方法参数中的位置
    ...
    /**
     * 调用 #getMapKey(Method method) 方法，获得注解的 {@link MapKey#value()}
     *
     * @param method
     * @return
     */
